<?php
	...
	if(isset($_SESSION['username_PTPradanaMesariJarot_car_rental']) && isset($_SESSION['password_PTPradanaMesariJarot_car_rental']))
	{
	...
	<body>
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="index.php">
				...
				<?php
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						if($count > 0)
						{
							...
							$_SESSION['username_PTPradanaMesariJarot_car_rental'] = $username;
							$_SESSION['password_PTPradanaMesariJarot_car_rental'] = $password;
							$_SESSION['user_id_PTPradanaMesariJarot_car_rental'] = $row['user_id'];
							header('Location: dashboard.php');
							die();
						}
						else
				...
				<span class="forgotPW">Forgot your password ? <a href="reset.php">Reset it here.</a></span>
			</form>
		</div>
